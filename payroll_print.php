...
$layout = new TLayout("print", "Office1City1", "MobileCity1");
$layout->version = 2;
...
$layout = new TLayout("masterprint", "Office1City1", "MobileCity1");
$layout->version = 2;
...
$page_layouts["periode_masterprint"] = $layout;
...
$params["selectedRecords"] = PrintPage::readSelectedRecordsFromRequest( "payroll" );
