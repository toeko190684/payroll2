...
$layout = new TLayout("edit_under_4col_center", "OfficeCity", "MobileCity");
$layout->version = 2;
...
$layout->containers["fields"][] = array("name"=>"editfields4_atop", 
	"block"=>"", "substyle"=>1  );
...
$page_layouts["Export_TXT_edit"] = $layout;
...
$keys = array();
$keys["payroll_id"] = postvalue("editid1");
