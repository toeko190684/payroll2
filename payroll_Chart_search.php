...
require_once("include/payroll_Chart_variables.php");
...
$layout = new TLayout("search2", "Office1City1", "MobileCity1");
$layout->version = 2;
...
$page_layouts["payroll_Chart_search"] = $layout;
...
$params['shortTableName'] = 'payroll_Chart';
